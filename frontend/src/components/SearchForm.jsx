...
export default function SearchForm() {
  ...
  const options = {
    localita: ['Bagnara', 'Bonemerse', 'Casalbuttano', 'Castelverde', 'Castelvetro Piacentino', 'Cremona', 'Gadesco Pieve Delmona', 'Pieve d\'Olmi', 'Seniga (Bs)'],
    ubicazione: ['Centrale', 'Fuori Città', 'Periferia', 'Semi-Centrale'],
    destinazione: ['Affitto', 'Affitto Semi Arredato', 'Vendita'],
    tipo: ['Attico', 'Bilocale', 'Box', 'Casa Indipendente', 'Cascina', 'Fabbricato', 'Laboratorio', 'Magazzino/Capannone'],
    camere: ['1', '2', '3', '4', '5', '6', '7', '8'],
    bagni: ['1', '2', '3', '4', '5', '6', '7', '8'],
  }

  // Filtra opzioni in base al testo inserito
  const getFilteredOptions = (key) => {
    const filter = filterText[key]?.toLowerCase() || ''
    return options[key].filter(option => option.toLowerCase().includes(filter))
  }
  ...
  const handleSearch = () => {
    console.log('Ricerca con:', formData)
    // Qui chiamerai l'API di ricerca
  }
    ...
    <div className="bg-gradient-to-r from-green-400 to-green-600 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white text-lg">Trova subito l'immobile adatto a te nella zona che vuoi. Comincia subito una ricerca!</p>
        </div>

        {/* Form */}
        <div className="bg-white rounded-lg shadow-xl p-8">
          {/* Prima riga - 4 dropdown */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {/* LOCALITA */}
            <div className="relative">
              <label className="block text-sm font-medium text-gray-700 mb-2">Località</label>
              <button
                onClick={() => setOpenDropdown(openDropdown === 'localita' ? null : 'localita')}
              ...
              {openDropdown === 'localita' && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10 max-h-60 overflow-hidden">
                  <input
                    ...
                    onChange={(e) => setFilterText({ ...filterText, localita: e.target.value })}
            ...
            <div className="relative">
              ...
              <button
                onClick={() => setOpenDropdown(openDropdown === 'ubicazione' ? null : 'ubicazione')}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white flex justify-between items-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
              ...
              {openDropdown === 'ubicazione' && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                  <input
                    ...
                    onChange={(e) => setFilterText({ ...filterText, ubicazione: e.target.value })}
                    className="w-full px-4 py-2 border-b border-gray-300 focus:outline-none"
                  />
            ...
            {/* DESTINAZIONE */}
            <div className="relative">
              <label className="block text-sm font-medium text-gray-700 mb-2">Destinazione</label>
              <button
                onClick={() => setOpenDropdown(openDropdown === 'destinazione' ? null : 'destinazione')}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white flex justify-between items-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
              ...
              {openDropdown === 'destinazione' && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                  <input
                    ...
                    onChange={(e) => setFilterText({ ...filterText, destinazione: e.target.value })}
                    className="w-full px-4 py-2 border-b border-gray-300 focus:outline-none"
                  />
                  <div className="max-h-48 overflow-y-auto">
              ...
              {openDropdown === 'tipo' && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                  <input
                    ...
                    onChange={(e) => setFilterText({ ...filterText, tipo: e.target.value })}
                    className="w-full px-4 py-2 border-b border-gray-300 focus:outline-none"
                  />
                  <div className="max-h-48 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="relative">
              ...
              <button
                onClick={() => setOpenDropdown(openDropdown === 'camereLettoMin' ? null : 'camereLettoMin')}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white flex justify-between items-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
                ...
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                  <div className="max-h-48 overflow-y-auto">
                    {options.camere.map((option) => (
                      <button
                        key={option}
                        onClick={() => handleDropdownChange('camereLettoMin', option)}
                        className="w-full text-left px-4 py-2 hover:bg-green-50 transition"
                      >
                        {option}
                      </button>
            ...
            <div className="relative">
              ...
              <button
                onClick={() => setOpenDropdown(openDropdown === 'bagniMin' ? null : 'bagniMin')}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white flex justify-between items-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-3">
                ...
                <div className="text-center text-xs text-gray-600 pt-1 border-t">
                  {(formData.prezzoMin).toLocaleString('it-IT')}€ - {(formData.prezzoMax).toLocaleString('it-IT')}€
                </div>
              </div>
            </div>
          ...
          {/* Bottone CERCA - Larghezza intera */}
          <button
