...
import { LogIn, Users, Facebook, Instagram } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex gap-6">
            ...
            <Link to="/agenzia" className="text-blue-600 font-medium">Agenzia</Link>
          </nav>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-6">Chi Siamo</h1>
        
        <div className="bg-white p-8 rounded-lg shadow mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">La Nostra Agenzia</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Benvenuti in Il Mondo Immobiliare, la vostra agenzia di fiducia nel settore immobiliare.
          </p>
          <p className="text-gray-700 leading-relaxed">
            Con anni di esperienza, aiutiamo clienti e proprietari a trovare le migliori soluzioni immobiliari.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <h3 className="text-lg font-bold mb-2">Team Professionale</h3>
            <p className="text-gray-600">Un team dedicato e competente al vostro servizio</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow">
            <Users className="w-8 h-8 text-blue-600 mb-3" />
            <h3 className="text-lg font-bold mb-2">Esperienza</h3>
            <p className="text-gray-600">Anni di esperienza nel settore immobiliare</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow">
            <Users className="w-8 h-8 text-blue-600 mb-3" />
            <h3 className="text-lg font-bold mb-2">Affidabilità</h3>
            <p className="text-gray-600">Trasparenza e professionalità in ogni trattativa</p>
          </div>
        </div>
      </div>
    </div>
