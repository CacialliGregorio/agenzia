...
export default function Immobili() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex gap-6">
            ...
            <Link to="/immobili" className="text-blue-600 font-medium">Immobili</Link>
      ...
      {/* Risultati ricerca (placeholder) */}
      <div className="max-w-7xl mx-auto px-4 py-12">
        <p className="text-gray-600 text-lg">(I risultati appariranno qui dopo la ricerca)</p>
      </div>
    </div>
  )
}
