...
public class ImmobileService {
    ...
    public Page<ImmobileDTO> cercaImmobili(String citta, String tipo, String stato, 
                                           BigDecimal prezzoMin, BigDecimal prezzoMax, 
                                           Pageable pageable) {
        Immobile.TipoImmobile tipoEnum = tipo != null ? Immobile.TipoImmobile.valueOf(tipo) : null;
        Immobile.Stato statoEnum = stato != null ? Immobile.Stato.valueOf(stato) : Immobile.Stato.DISPONIBILE;
        
        return immobileRepository.cercaImmobili(citta, tipoEnum, statoEnum, prezzoMin, prezzoMax, pageable)
                .map(this::convertToDTO);
    }
